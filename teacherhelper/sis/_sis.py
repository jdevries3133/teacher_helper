...
class Sis(OnCourseMixin):
    ...
    def find_student(self, student_name: str, threshold: int=90) -> Union[Student, None]:
    ...
    def find_parent(self, parent_name: str, threshold: int=70) -> Union[ParentGuardian, None]:
        ...
        if name_match and name_match[1] > threshold and (mo := all_guardians.get(name_match[0])):
            return mo
